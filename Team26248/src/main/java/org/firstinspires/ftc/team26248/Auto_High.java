...
public class Auto_High extends LinearOpMode {
    ...
    private final double ARM_DOWN = -3000;//TODO:need to change
    private final double ARM_UP = -1400;//TODO:need to change
    private final double slide_expanded = 0; //TODO:need to change
    private final double slide_contracted = 0;//TODO:need to change
